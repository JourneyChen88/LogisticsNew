...
namespace Logistics.WebApi.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<AjaxResponse<List<AccountDto>>> GetAll(long userId)
        {
        ...
        [HttpGet]
        public async Task<AjaxResponse<List<AccountDto>>> GetList( )
        {
            var res = await _appservice.GetList();
            return new AjaxResponse<List<AccountDto>>(res);
        }
        /// <summary>
        /// 获取分页
